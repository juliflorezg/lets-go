...
type application struct {
	logger         *slog.Logger
	snippets       models.SnippetModelInterface // use of interfaces defined in models package
	users          models.UserModelInterface    // use of interfaces defined in models package
